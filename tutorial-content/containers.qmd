...
RUN R -e 'install.packages("dplyr")'                         # <3>
COPY analysis.R $HOME/analysis.R                             # <4>
CMD ["Rscript", "analysis.R"]
```

1. `rocker/r-ver` might be interpretted differently depending on your container
   runtime. `docker` will expand this to `https://docker.io/rocker/r-ver:latest`,
