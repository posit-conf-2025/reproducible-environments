...
- At Novartis we needed the {rbmi} package for multiple imputation
...
%%| echo: false
timeline
    title Novartis Legacy Approch -  R environments with ~6 month refresh
...
::: {.column width="70%"}
![](images/frozenVrolling.gif){ .dropshadow .padded }
:::
